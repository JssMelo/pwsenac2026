...
$dados = $pdo->query("SELECT * FROM programacao ORDER BY data, hora")->fetchAll(PDO::FETCH_ASSOC);
?>
...
<main class="container">
    <h2>Programação Festival do Senhor 2026</h2>
    <?php if(isset($_SESSION['msg'])): ?>
        <div class="alert">
            <?= $_SESSION['msg']; unset($_SESSION['msg']); ?>
        </div>
    <?php endif; ?>
    <a href="form.php" class="btn">Cadastrar Momento</a>
    <table>
        <tr>
            <th>Data</th>
            <th>Hora</th>
